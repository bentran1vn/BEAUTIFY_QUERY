...
internal sealed class SubscriptionActivateEventHandler : ICommandHandler<DomainEvents.SubscriptionActivated>
{
    ...
    public async Task<Result> Handle(DomainEvents.SubscriptionActivated request, CancellationToken cancellationToken)
    {
