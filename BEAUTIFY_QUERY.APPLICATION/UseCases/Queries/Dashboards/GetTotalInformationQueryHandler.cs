...
public class
    GetTotalInformationQueryHandler : IQueryHandler<Query.GetTotalInformationQuery,
    Responses.GetTotalInformationResponse>
{
    ...
    public GetTotalInformationQueryHandler(IRepositoryBase<Clinic, Guid> clinicRepository,
    ...
    public async Task<Result<Responses.GetTotalInformationResponse>> Handle(Query.GetTotalInformationQuery request,
