...
public class GetEventQueryHandler : IQueryHandler<Query.GetEventQuery, PagedResult<Response.EventResponse>>
{
    private readonly IRepositoryBase<Event, Guid> _eventRepository;

    public GetEventQueryHandler(IRepositoryBase<Event, Guid> eventRepository)
    {
        _eventRepository = eventRepository;
    }

    public async Task<Result<PagedResult<Response.EventResponse>>> Handle(Query.GetEventQuery request, CancellationToken cancellationToken)
    {
